...
class StartHandler(BaseHandler):
    ...
    async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
        await update.message.reply_text(
            ...
            "/add <имя_бравлера>, <дата (ГГГГ-ММ-ДД) | today/сегодня>, <название_скина> — добавить бравлера\n"
            ...
            "/upd <имя_бравлера>, <дата (ГГГГ-ММ-ДД) | today/сегодня>, <название_скина> — обновить дату последнего скина\n"
            "Используй 'today' или 'сегодня', чтобы установить текущую дату.\n\n"
